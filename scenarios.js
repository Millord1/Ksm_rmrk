...
exports.obxiumBlocks = exports.defaultWalker = void 0;
const StartScan_js_1 = require("./StartScan.js");
const { program } = require('commander');
const fs = require('fs');
const path = require('path');
var exec = require('child_process').exec, child;
const defaultWalker = (opts) => {
    ...
    blocks.forEach(blockIndex => {
        setTimeout(function () { console.log("reading" + blockIndex); StartScan_js_1.forceScan(blockIndex); }, speed * index);
        index++;
    });
};
exports.defaultWalker = defaultWalker;
const obxiumBlocks = (opts) => {
    // let blocks : Array<number> = [
    //
...
exports.obxiumBlocks = obxiumBlocks;
//
