...
const WestendBlockchain_1 = require("./sandra/src/CSCannon/Substrate/Westend/WestendBlockchain");
...
async function bootstrapCollection() {
    ...
    let rmrkContractStandard = new RmrkContractStandard_js_1.RmrkContractStandard(canonizeManager);
...
async function bootstrapEvents() {
    ...
    let event = new BlockchainEvent_js_1.BlockchainEvent(kusama.eventFactory, 'address1', 'addressDest1', myCOntract, 'txid1111', '1111111', "1", kusama, 3, rmrkToken, canonizeManager.getSandra());
