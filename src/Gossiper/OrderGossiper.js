...
class OrderGossiper extends GossiperManager_1.GossiperManager {
    ...
    gossip() {
        ...
        let order = new BlockchainOrder_1.BlockchainOrder(this.chain.orderFactory, source, contractBuy, contractSell, buyAmount, sellPrice, total, txId, timestamp, this.chain, this.blockId, ksmContractStd, rmrkStd, sandra);
    }
}
