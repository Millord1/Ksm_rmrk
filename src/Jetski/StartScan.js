...
const Unique_1 = require("../Blockchains/Unique");
const fs = require('fs');
            ...
            if (currentBlock != blockNumber) {
                ...
                jetski.getBlockContent(blockNumber, api)
                    ...
                    if (e == Jetski_1.Jetski.noBlock) {
                        ...
                        instanceManager = new InstanceManager_1.InstanceManager(canonize, chainName, instanceManager.getJwt());
