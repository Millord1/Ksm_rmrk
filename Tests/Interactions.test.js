...
const block = 8920434;
const metaUrl = "https://cloudflare-ipfs.com/ipfs/bafkreibe6nd2u7mviltfaukvyowlov2wlwygn67fu7vcpfxxjlzmjcav3i";
const meta = {
...
const metaData = new MetaData_1.MetaData(metaUrl, meta);
...
describe('basic interactions', () => {
    test("Mint", () => {
        ...
        if (mint instanceof Mint_1.Mint) {
            (_a = mint.collection) === null || _a === void 0 ? void 0 : _a.addMetadata(metaData);
            ...
            expect((_d = (_c = mint.collection) === null || _c === void 0 ? void 0 : _c.metaData) === null || _d === void 0 ? void 0 : _d.url).toBe(metaUrl);
    ...
    test("MintNft", () => {
        ...
        if (mintNft instanceof MintNft_1.MintNft) {
            (_a = mintNft.asset) === null || _a === void 0 ? void 0 : _a.addMetadata(metaData);
            ...
            expect((_d = (_c = mintNft.asset) === null || _c === void 0 ? void 0 : _c.metaData) === null || _d === void 0 ? void 0 : _d.url).toBe(metaUrl);
        }
    });
    test("Send", () => {
        var _a, _b, _c;
        ...
        const value = "1";
        const tx = new Transaction_1.Transaction(block, txHash, timestamp, blockchain, source, destination, value);
        const rmrkReader = new RmrkReader_1.RmrkReader(blockchain, tx);
