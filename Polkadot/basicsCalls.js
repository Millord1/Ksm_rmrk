...
var getDatas = /** @class */ (function () {
    ...
    getDatas.prototype.testRmrk = function () {
        return __awaiter(this, void 0, void 0, function () {
            var api, rmrk;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        api = _c.sent();
                        return [4 /*yield*/, api.rpc.chain.getBlockHash(blockNum)];
                    case 2:
                        blockHash = _c.sent();
                        return [4 /*yield*/, api.rpc.chain.getBlock(blockHash)];
                    case 3:
                        block = _c.sent();
                        _i = 0, _a = block.block.extrinsics;
                        _c.label = 4;
                    case 4:
                        if (!(_i < _a.length)) return [3 /*break*/, 7];
                        ex = _a[_i];
                        _b = ex.method, args = _b.args, method = _b.method, section = _b.section;
                        return [4 /*yield*/, api.query.nft.nftItemList(args[1], args[2])];
                    case 5:
                        Owner = (_c.sent()).Owner;
                        console.log(Owner);
                        _c.label = 6;
...
var myAddr = new getDatas(OBXIUM);
// myAddr.balance();
// myAddr.basicDatas();
